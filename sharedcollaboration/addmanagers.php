...
if(isset($_POST['collaboratorID']) && isset($_POST['collaboratorUsername']) && isset($_POST['collaboratorMaker']) && isset($_POST['taskID'])) {
    ...
    $checkSql = "SELECT * FROM collaborators WHERE CollaboratorID = '$collaboratorID' AND CollaboratorManager = '$collaboratorUsername'";
    $checkResult = mysqli_query($link, $checkSql);
    if(mysqli_num_rows($checkResult) == 0) {
        // Insert into collaborators table
        $insertSql = "INSERT INTO collaborators (CollaboratorID, CollaboratorManager, CollaboratorMaker, SharedDateTime, TaskID) VALUES ('$collaboratorID', '$collaboratorUsername', '$collaboratorMaker', '$currentDateTimeFormatted', '$taskID')"; // Include TaskID
